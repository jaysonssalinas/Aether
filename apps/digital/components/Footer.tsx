      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="flex flex-col gap-4">
            <AetherLogo size="sm" subtitle="Digital" />
            <p className="text-sm leading-relaxed" style={{ color: '#666666', maxWidth: '240px' }}>
              Websites, software systems, and digital infrastructure for Philippine businesses.
            </p>
          </div>
          <div className="flex flex-col gap-4">
            <h4 className="text-xs tracking-[0.2em] uppercase" style={{ color: '#999999' }}>Services</h4>
            {['Web Design', 'Software Systems', 'Domain & Hosting', 'SEO'].map((s) => (
        ...
        <div className="mt-16 pt-6 flex justify-between items-center" style={{ borderTop: '1px solid #1e1e1e' }}>
          <p className="text-xs" style={{ color: '#444444' }}>© 2026 Aether Digital. All rights reserved.</p>
